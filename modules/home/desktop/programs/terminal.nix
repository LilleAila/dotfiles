        ...
        lib.mkMerge [
          (lib.mkIf (config.settings.terminal.emulator.name == "ghostty") {
            ...
            programs.ghostty = {
              ...
              themes.${self.colorScheme.slug} = with self.colorScheme.palette; {
                background = base00;
                cursor-color = base06;
                cursor-text = base00;
                foreground = base06;
          ...
          (lib.mkIf (config.settings.terminal.emulator.name == "kitty") {
            ...
            programs.kitty = {
              ...
              settings = with self.colorScheme.palette; {
          ...
          (lib.mkIf (config.settings.terminal.emulator.name == "wezterm") {
            ...
            programs.wezterm = {
              ...
              colorSchemes = {
                base16 = with self.colorScheme.palette; {
                  foreground = "#${base06}";
                  background = "#${base00}";
                  cursor_bg = "#${base06}";
                  cursor_fg = "#${base00}";
          ...
          (lib.mkIf (config.settings.terminal.emulator.name == "alacritty") {
            ...
            programs.alacritty = {
              ...
              settings = {
                ...
                colors = with self.colorScheme.palette; {
                  bright = {
                    black = "0x${base00}";
                    blue = "0x${base0D}";
                    cyan = "0x${base0C}";
